...
import SettingsPaymentGatewayHuifu from '../../pages/Setting/Payment/SettingsPaymentGatewayHuifu';
        ...
        <Card style={{ marginTop: '10px' }}>
          ...
          >
            ...
            >
              ...
              <Tabs.TabPane tab={t('Huifu 设置')} itemKey='huifu'>
                <SettingsPaymentGatewayHuifu
                  options={inputs}
                  refresh={onRefresh}
                  hideSectionTitle
                />
